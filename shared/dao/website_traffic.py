    ...
    try:
        with _db.session() as s:
            ...
            row = {
                ...
                "desktop_share": _to_float(payload.get("desktop_share")),
                "mobile_share": _to_float(payload.get("mobile_share")),
                "direct_share": _to_float(payload.get("direct_share")),
                "search_share": _to_float(payload.get("search_share")),
                "social_share": _to_float(payload.get("social_share")),
    ...
    try:
        with _db.session() as s:
            ...
            return {
                ...
                "desktop_share": row.desktop_share,
                "mobile_share": row.mobile_share,
                "direct_share": row.direct_share,
                "search_share": row.search_share,
